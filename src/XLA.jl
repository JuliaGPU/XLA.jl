...
ENV["LIBTENSORFLOW"]="/home/keno/tensorflow/bazel-bin/tensorflow/compiler/xla/julia/libjlxla.so"
include(Pkg.dir("XLA","src","gen","xla.jl"))
using .xla
using Revise
yield()
using ProtoBuf
...
using Cxx
Cxx.addHeaderDir("/home/keno/.cache/bazel/_bazel_keno/194f131dbf4e1f471c25958d40967b3c/external/protobuf_archive/src/", kind=C_System)
Cxx.addHeaderDir("/home/keno/.cache/bazel/_bazel_keno/194f131dbf4e1f471c25958d40967b3c/execroot/org_tensorflow/bazel-out/host/genfiles/")
Cxx.addHeaderDir("/home/keno/.cache/bazel/_bazel_keno/194f131dbf4e1f471c25958d40967b3c/execroot/org_tensorflow/bazel-out/k8-py3-opt/genfiles/")
Cxx.addHeaderDir("/home/keno/tensorflow/")
Cxx.addHeaderDir("/home/keno/.cache/bazel/_bazel_keno/194f131dbf4e1f471c25958d40967b3c/external/eigen_archive", kind=C_System)
Libdl.dlopen(ENV["LIBTENSORFLOW"], Libdl.RTLD_GLOBAL)
        ...
        if isexpr(expr, :call)
            if Compiler.is_known_call(expr, Base.broadcast, ir, ir.mod)
                ...
                if isa(broadcastee, Compiler.IRCode)
                    ...
                    (f, ft) = bt
                    atype = Tuple{Compiler.widenconst(ft), (Float64 for i = 1:nargs)...}
                ...
                broadcastee_xla = generate_xla_from(sub_builder,
                  ...
                  [Shape(element_type=convert(XlaType, Float64).which) for _=1:nargs])
