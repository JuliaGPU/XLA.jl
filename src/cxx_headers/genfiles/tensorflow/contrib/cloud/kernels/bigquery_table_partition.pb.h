...
#ifndef PROTOBUF_tensorflow_2fcontrib_2fcloud_2fkernels_2fbigquery_5ftable_5fpartition_2eproto_INCLUDED
#define PROTOBUF_tensorflow_2fcontrib_2fcloud_2fkernels_2fbigquery_5ftable_5fpartition_2eproto_INCLUDED
...
void AddDescriptors();
void InitDefaultsBigQueryTablePartitionImpl();
void InitDefaultsBigQueryTablePartition();
inline void InitDefaults() {
  InitDefaultsBigQueryTablePartition();
}
}  // namespace protobuf_tensorflow_2fcontrib_2fcloud_2fkernels_2fbigquery_5ftable_5fpartition_2eproto
...
namespace google {
namespace protobuf {
template<> ::tensorflow::BigQueryTablePartition* Arena::Create< ::tensorflow::BigQueryTablePartition>(Arena*);
}  // namespace protobuf
}  // namespace google
namespace tensorflow {
...
class BigQueryTablePartition : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:tensorflow.BigQueryTablePartition) */ {
 public:
  ...
  inline BigQueryTablePartition* New() const PROTOBUF_FINAL {
    return ::google::protobuf::Arena::Create<BigQueryTablePartition>(NULL);
  }

  BigQueryTablePartition* New(::google::protobuf::Arena* arena) const PROTOBUF_FINAL {
    return ::google::protobuf::Arena::Create<BigQueryTablePartition>(arena);
  }
 ...
 private:
  ...
  friend void ::protobuf_tensorflow_2fcontrib_2fcloud_2fkernels_2fbigquery_5ftable_5fpartition_2eproto::InitDefaultsBigQueryTablePartitionImpl();
};
// ===================================================================
...
#endif  // PROTOBUF_tensorflow_2fcontrib_2fcloud_2fkernels_2fbigquery_5ftable_5fpartition_2eproto_INCLUDED
