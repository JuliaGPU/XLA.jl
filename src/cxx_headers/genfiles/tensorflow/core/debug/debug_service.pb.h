...
#ifndef PROTOBUF_tensorflow_2fcore_2fdebug_2fdebug_5fservice_2eproto_INCLUDED
#define PROTOBUF_tensorflow_2fcore_2fdebug_2fdebug_5fservice_2eproto_INCLUDED
...
inline void InitDefaults() {
  InitDefaultsEventReply_DebugOpStateChange();
  InitDefaultsEventReply();
  InitDefaultsCallTraceback_OriginIdToStringEntry_DoNotUse();
  InitDefaultsCallTraceback();
}
}  // namespace protobuf_tensorflow_2fcore_2fdebug_2fdebug_5fservice_2eproto
...
namespace google {
namespace protobuf {
template<> ::tensorflow::CallTraceback* Arena::Create< ::tensorflow::CallTraceback>(Arena*);
template<> ::tensorflow::CallTraceback_OriginIdToStringEntry_DoNotUse* Arena::Create< ::tensorflow::CallTraceback_OriginIdToStringEntry_DoNotUse>(Arena*);
template<> ::tensorflow::EventReply* Arena::Create< ::tensorflow::EventReply>(Arena*);
template<> ::tensorflow::EventReply_DebugOpStateChange* Arena::Create< ::tensorflow::EventReply_DebugOpStateChange>(Arena*);
}  // namespace protobuf
}  // namespace google
namespace tensorflow {
...
class EventReply_DebugOpStateChange : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:tensorflow.EventReply.DebugOpStateChange) */ {
 public:
  ...
  inline EventReply_DebugOpStateChange* New() const PROTOBUF_FINAL {
    return ::google::protobuf::Arena::Create<EventReply_DebugOpStateChange>(NULL);
  }

  EventReply_DebugOpStateChange* New(::google::protobuf::Arena* arena) const PROTOBUF_FINAL {
    return ::google::protobuf::Arena::Create<EventReply_DebugOpStateChange>(arena);
  }
 ...
 private:
  ...
  friend void ::protobuf_tensorflow_2fcore_2fdebug_2fdebug_5fservice_2eproto::InitDefaultsEventReply_DebugOpStateChangeImpl();
};
// -------------------------------------------------------------------
...
class EventReply : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:tensorflow.EventReply) */ {
 public:
  ...
  inline EventReply* New() const PROTOBUF_FINAL {
    return ::google::protobuf::Arena::Create<EventReply>(NULL);
  }

  EventReply* New(::google::protobuf::Arena* arena) const PROTOBUF_FINAL {
    return ::google::protobuf::Arena::Create<EventReply>(arena);
  }
  void CopyFrom(const ::google::protobuf::Message& from) PROTOBUF_FINAL;
  void MergeFrom(const ::google::protobuf::Message& from) PROTOBUF_FINAL;
 ...
 private:
  ...
  mutable int _cached_size_;
  friend struct ::protobuf_tensorflow_2fcore_2fdebug_2fdebug_5fservice_2eproto::TableStruct;
  friend void ::protobuf_tensorflow_2fcore_2fdebug_2fdebug_5fservice_2eproto::InitDefaultsEventReplyImpl();
};
// -------------------------------------------------------------------
...
class CallTraceback : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:tensorflow.CallTraceback) */ {
 public:
  ...
  inline CallTraceback* New() const PROTOBUF_FINAL {
    return ::google::protobuf::Arena::Create<CallTraceback>(NULL);
  }

  CallTraceback* New(::google::protobuf::Arena* arena) const PROTOBUF_FINAL {
    return ::google::protobuf::Arena::Create<CallTraceback>(arena);
  }
  void CopyFrom(const ::google::protobuf::Message& from) PROTOBUF_FINAL;
  void MergeFrom(const ::google::protobuf::Message& from) PROTOBUF_FINAL;
 ...
 private:
  ...
  mutable int _cached_size_;
  friend struct ::protobuf_tensorflow_2fcore_2fdebug_2fdebug_5fservice_2eproto::TableStruct;
  friend void ::protobuf_tensorflow_2fcore_2fdebug_2fdebug_5fservice_2eproto::InitDefaultsCallTracebackImpl();
};
// ===================================================================
...
inline ::tensorflow::tfprof::CodeDef* CallTraceback::mutable_origin_stack() {
  ...
  if (origin_stack_ == NULL) {
    origin_stack_ = ::google::protobuf::Arena::Create< ::tensorflow::tfprof::CodeDef >(
        GetArenaNoVirtual());
  }
...
inline ::tensorflow::tfprof::OpLogProto* CallTraceback::mutable_graph_traceback() {
  ...
  if (graph_traceback_ == NULL) {
    graph_traceback_ = ::google::protobuf::Arena::Create< ::tensorflow::tfprof::OpLogProto >(
        GetArenaNoVirtual());
  }
...
#endif  // PROTOBUF_tensorflow_2fcore_2fdebug_2fdebug_5fservice_2eproto_INCLUDED
