...
#ifndef PROTOBUF_tensorflow_2fcore_2fprofiler_2ftfprof_5foptions_2eproto_INCLUDED
#define PROTOBUF_tensorflow_2fcore_2fprofiler_2ftfprof_5foptions_2eproto_INCLUDED
...
inline void InitDefaults() {
  InitDefaultsOptionsProto();
  InitDefaultsAdvisorOptionsProto_CheckersEntry_DoNotUse();
  InitDefaultsAdvisorOptionsProto_CheckerOption_OptionsEntry_DoNotUse();
  InitDefaultsAdvisorOptionsProto_CheckerOption();
  InitDefaultsAdvisorOptionsProto();
}
}  // namespace protobuf_tensorflow_2fcore_2fprofiler_2ftfprof_5foptions_2eproto
...
namespace google {
namespace protobuf {
template<> ::tensorflow::tfprof::AdvisorOptionsProto* Arena::Create< ::tensorflow::tfprof::AdvisorOptionsProto>(Arena*);
template<> ::tensorflow::tfprof::AdvisorOptionsProto_CheckerOption* Arena::Create< ::tensorflow::tfprof::AdvisorOptionsProto_CheckerOption>(Arena*);
template<> ::tensorflow::tfprof::AdvisorOptionsProto_CheckerOption_OptionsEntry_DoNotUse* Arena::Create< ::tensorflow::tfprof::AdvisorOptionsProto_CheckerOption_OptionsEntry_DoNotUse>(Arena*);
template<> ::tensorflow::tfprof::AdvisorOptionsProto_CheckersEntry_DoNotUse* Arena::Create< ::tensorflow::tfprof::AdvisorOptionsProto_CheckersEntry_DoNotUse>(Arena*);
template<> ::tensorflow::tfprof::OptionsProto* Arena::Create< ::tensorflow::tfprof::OptionsProto>(Arena*);
}  // namespace protobuf
}  // namespace google
namespace tensorflow {
namespace tfprof {
...
class OptionsProto : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:tensorflow.tfprof.OptionsProto) */ {
 public:
  ...
  inline OptionsProto* New() const PROTOBUF_FINAL {
    return ::google::protobuf::Arena::Create<OptionsProto>(NULL);
  }

  OptionsProto* New(::google::protobuf::Arena* arena) const PROTOBUF_FINAL {
    return ::google::protobuf::Arena::Create<OptionsProto>(arena);
  }
 ...
 private:
  ...
  friend void ::protobuf_tensorflow_2fcore_2fprofiler_2ftfprof_5foptions_2eproto::InitDefaultsOptionsProtoImpl();
};
// -------------------------------------------------------------------
...
class AdvisorOptionsProto_CheckerOption : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:tensorflow.tfprof.AdvisorOptionsProto.CheckerOption) */ {
 public:
  ...
  inline AdvisorOptionsProto_CheckerOption* New() const PROTOBUF_FINAL {
    return ::google::protobuf::Arena::Create<AdvisorOptionsProto_CheckerOption>(NULL);
  }

  AdvisorOptionsProto_CheckerOption* New(::google::protobuf::Arena* arena) const PROTOBUF_FINAL {
    return ::google::protobuf::Arena::Create<AdvisorOptionsProto_CheckerOption>(arena);
  }
  void CopyFrom(const ::google::protobuf::Message& from) PROTOBUF_FINAL;
  void MergeFrom(const ::google::protobuf::Message& from) PROTOBUF_FINAL;
 ...
 private:
  ...
  mutable int _cached_size_;
  friend struct ::protobuf_tensorflow_2fcore_2fprofiler_2ftfprof_5foptions_2eproto::TableStruct;
  friend void ::protobuf_tensorflow_2fcore_2fprofiler_2ftfprof_5foptions_2eproto::InitDefaultsAdvisorOptionsProto_CheckerOptionImpl();
};
// -------------------------------------------------------------------
...
class AdvisorOptionsProto : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:tensorflow.tfprof.AdvisorOptionsProto) */ {
 public:
  ...
  inline AdvisorOptionsProto* New() const PROTOBUF_FINAL {
    return ::google::protobuf::Arena::Create<AdvisorOptionsProto>(NULL);
  }

  AdvisorOptionsProto* New(::google::protobuf::Arena* arena) const PROTOBUF_FINAL {
    return ::google::protobuf::Arena::Create<AdvisorOptionsProto>(arena);
  }
  void CopyFrom(const ::google::protobuf::Message& from) PROTOBUF_FINAL;
  void MergeFrom(const ::google::protobuf::Message& from) PROTOBUF_FINAL;
 ...
 private:
  ...
  mutable int _cached_size_;
  friend struct ::protobuf_tensorflow_2fcore_2fprofiler_2ftfprof_5foptions_2eproto::TableStruct;
  friend void ::protobuf_tensorflow_2fcore_2fprofiler_2ftfprof_5foptions_2eproto::InitDefaultsAdvisorOptionsProtoImpl();
};
// ===================================================================
...
#endif  // PROTOBUF_tensorflow_2fcore_2fprofiler_2ftfprof_5foptions_2eproto_INCLUDED
